...
// Make CRM_Xcm_ExtensionUtil available.
require_once __DIR__ . '/../../xcm.civix.php';
...
addExtensionToClassLoader($loader, 'de.systopia.xcm');
 ...
 */
function _xcm_test_civicrm_container(ContainerBuilder $container): void {
}
