 ...
 */
class CRM_Xcm_Upgrader_Base {

  /**
   * @var CRM_Xcm_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Xcm_Upgrader(
        'de.systopia.xcm',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Xcm_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Xcm_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
