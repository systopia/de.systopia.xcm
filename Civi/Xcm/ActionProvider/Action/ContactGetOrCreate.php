...
class ContactGetOrCreate extends AbstractAction {
   ...
   */
  private int $customParameterCount = 2;

  /**
   * @return int
   */
  public function getCustomParameterCount(): int {
    return $this->customParameterCount;
  }
  ...
  public function getConfigurationSpecification() {
    ...
    // add variable fields
    for ($number = 1; $number <= $this->getCustomParameterCount(); $number++) {
      $configuration[] = new Specification(
